...
<script>
    ...
    <script>
        document.getElementById("event-form").addEventListener("submit", function(event) {
            ...
            newEvent.classList.add("bg-gray-800", "p-6", "rounded-lg", "shadow-lg", "hover:scale-105", "transition-transform");
            newEvent.innerHTML = `
    ...
    <section id="gallery" class="p-8 text-center fade-in">
        ...
        <div class="mt-6 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
            ...
            <img src="data:image/jpeg;base64," alt="Gallery Image" class="rounded-lg shadow-lg hover:scale-105 transition transform duration-300">
    ...
    <div class="mt-6 bg-gray-800 p-6 rounded-lg">
        ...
        <div class="text-left mt-6">
            ...
            <ul id="forum-list" class="mt-4 space-y-4">
                <li class="bg-gray-700 p-4 rounded-lg">How to improve coding speed? - <span class="text-gray-400">by Snehasish Nag</span></li>
                <li class="bg-gray-700 p-4 rounded-lg">Best resources for Data Structures - <span class="text-gray-400">by Debopam Sarkar</span></li>
                <li class="bg-gray-700 p-4 rounded-lg">Tips for first hackathon - <span class="text-gray-400">by Prolayjit Biswas</span></li>
            </ul>
        </div>
    </div>
</section>
...
document.getElementById("forum-form").addEventListener("submit", function(event) {
    ...
    newDiscussion.classList.add("bg-gray-700", "p-4", "rounded-lg", "fade-in");
    newDiscussion.innerHTML = ${discussionText} - <span class="text-gray-400">by Anonymous</span>;
